            ...
            <div className="flex flex-col w-[75%] gap-[20px]">
                ...
                <form className="w-full" onSubmit={(event)=>{handleSubmit(event)}}>
                    ...
                    <div className="flex justify-end">
                        <input disabled={pageState.isLoading} type='submit' value={(pageState.isLoading?"Sendind...":"Next")} className={`bg-orange w-[150px] border-none outline-none text-white fontEpilouge font-extrabold p-1 rounded-md my-10 ${(pageState.isLoading? "opacity-50":"")}`}/>
                    </div>
                </form>
            </div>
        </div>
